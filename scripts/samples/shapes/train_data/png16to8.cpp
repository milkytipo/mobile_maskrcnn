...
int main(void){
    ...
    char buff2[100];
    for(int i=1;i<30;i++){
        sprintf(buff1,"/media/tx2/Drive/wuzida/catkin_ws/src/maskRCNN/dataset/labelme_json/%d_json/label.png",i);
        sprintf(buff2,"/media/tx2/Drive/wuzida/catkin_ws/src/maskRCNN/dataset/cv_mask/%d.png",i);
